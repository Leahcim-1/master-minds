...
% TODO screenshot of 64 chunks showing load balance issues
...
% TODO screenshot of 512 chunks showing improved load balancing
Increasing $n$ past 512 results in minimal performance gains, as the load is already evenly balanced.
% TODO graph showing performance vs. number of chunks
...
% TODO do we need to discuss these shrinking chunk results quantitatively?

\section{Conclusion}
% TODO bar graph showing best times from each method
...
\label{sec:code}
TODO
%TODO: include all code files with minted
